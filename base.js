...
Base.prototype.animate = function(obj) {
	for(var i = 0; i < this.elements.length; ++i) {
		var element = this.elements[i];
		//obj.beToEnd表示有新动画时将旧动画置为末尾状态
		if(undefined != element.timer && undefined != element.obj && element.obj.bToEnd){
			this.animateToTarget(element.obj);
		}
...
Base.prototype.animateToTarget = function(obj) {
