<?php
	...
	if($_POST['type'] == "all"){
		...
		$query = mysql_query("UPDATE blog_skin SET bg_flag=0 WHERE bg_flag=1") or die('SQL错误！');
		$query = mysql_query("UPDATE blog_skin SET bg_flag=1 WHERE big_bg='{$_POST['big_bg']}'") or die('SQL错误！');
